...
friendsdb_file = aws3.get_db('friendsdb')
userdb_file = aws3.get_db('userdb')
warikandb_file = aws3.get_db('warikandb')

friendsdb = TinyDB(friendsdb_file)
userdb = TinyDB(userdb_file)
warikandb = TinyDB(warikandb_file)
